...
echo ""
echo "Next steps:"
echo "  1. Deploy frontend so https://getjamie.app/.well-known/apple-app-site-association is reachable."
echo "  2. Verify: curl -I https://getjamie.app/.well-known/apple-app-site-association"
echo "     — must return Content-Type: application/json (NOT application/pkcs7-mime)"
echo "  3. In Xcode: enable 'Associated Domains' capability → add applinks:getjamie.app"
